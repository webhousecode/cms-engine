...
Zero-framework static site generator. A custom `build.ts` reads JSON content and outputs plain HTML with Marked for markdown rendering. No React, no bundler, no runtime JS.
...
cd cms/examples/static-boilerplate
npm install
