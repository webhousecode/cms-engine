...
The actual webhouse.app marketing site. Advanced custom `build.ts` with 6 block types including terminal animation, stats bar, and MCP cards.

**Live demo:** [https://webhouse.app](https://webhouse.app)
...
cd cms/examples/landing
npm install

# Start development
npx cms dev --port 3020
...
1 collection: `pages` with 6 block types
